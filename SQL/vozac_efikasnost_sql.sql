...
prosjecna_potrosnja_goriva) values
('OS2265PK','Scania R500',2019,23.56),
('OS7754OT','Scania R500 V8',2010,30.11),
('OS8657IH','Man TG 420',2010,29.13),
('OS1145TU','Man TGX 460',2018,27.50),
('OS3764RR','Volvo FH500',2015,25.88),
...
('osijek-čakovec','2024-03-17',242.45,244.34,70.22,2,2),
('osijek-rijeka','2024-04-13',444.67,447.21,120.11,5,2),
('osijek-zagreb','2024-03-14',223.34,240.25,65.58,1,3),
('osijek-rijeka','2024-04-09',444.67,470.77,137.55,4,3),
('osijek-sl.brod','2024-03-20',94.67,100.45,37.54,3,4),
('osijek-čakovec','2024-04-09',242.45,257.45,77.23,5,4),
('osijek-split','2024-03-13',687.09,689.22,197.34,2,5),
('osijek-zagreb','2024-04-23',223.34,224.67,59.91,3,5),
('osijek-sl.brod','2024-03-08',94.67,96.02,27.46,6,6),
('osijek-split','2024-04-15',687.09,691.11,196.11,4,6
);